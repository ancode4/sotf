import ForgeUI, { render, Fragment, Text, Strong, IssueGlance, useProductContext, useState } from '@forge/ui';
...
/*
  const componentsName = components.forEach(function(element) {
